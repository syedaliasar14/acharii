...
export default function PaymentSuccess() {
  ...
  return (
    <main className="flex flex-col flex-grow justify-center items-center text-center gap-4 min-h-full bg-primary">
      <div className="flex flex-col gap-4 my-auto py-12">
        ...
        <Link href="/products" className="px-4 py-2 w-xs md:w-md flex justify-center gap-2 items-center rounded-md cursor-pointer transition-colors shadow-sm bg-secondary/80 hover:bg-secondary">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
